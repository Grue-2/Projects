...
public interface AES
{
  public static void generateAESKeyFile() throws NoSuchAlgorithmException, FileNotFoundException, IOException {
    ...
    KeyGenerator gen = KeyGenerator.getInstance("AES");gen.init(128, rng);
  ...
  public static void encrypt(String inputFileName, String outputFileName) throws NoSuchAlgorithmException, InvalidKeyException, FileNotFoundException, ClassNotFoundException, IOException, javax.crypto.NoSuchPaddingException, javax.crypto.IllegalBlockSizeException, BadPaddingException, java.security.InvalidAlgorithmParameterException { 
	Cipher c = Cipher.getInstance("AES");c.init(1, getAESKey());
  ...
  public static void decrypt(String inputFileName, String outputFileName) throws IOException, InvalidKeyException, ClassNotFoundException, NoSuchAlgorithmException, javax.crypto.NoSuchPaddingException, javax.crypto.IllegalBlockSizeException, BadPaddingException, java.security.InvalidAlgorithmParameterException { 
	byte[] b_ct = Files.readAllBytes(Paths.get(inputFileName, new String[0]));
    Cipher c = Cipher.getInstance("AES");c.init(2, getAESKey());
