...
## Encryption
<a name="5"></a>
### OTP_With_Integrity_Attempt - one time pad(scramble(padding(hash(message) + message))) 

#### Preface
I have reservations about the security of this project. (tests in the works)
...
#### OTP_With_Integrity_Attempt2(Defunct - scrambling error)
